...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude
                  → checks /Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/get-shit-done
                  → writes to /Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
