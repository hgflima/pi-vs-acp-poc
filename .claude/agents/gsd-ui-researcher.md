...
Use template from `/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
