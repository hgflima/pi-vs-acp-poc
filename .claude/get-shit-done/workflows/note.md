...
- **Global scope**: `/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/notes/`)
...
2. Glob `/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/henriquelima/Documents/dev/personal/pi-ai-poc/.claude/notes/` — works in any directory
